"""ImageNet-1k (ILSVRC 2012) class names, 0-indexed.

Public factual data in the standard torchvision/ultralytics order — the
order must match the training set of any exported yolov8n-cls.onnx, or the
labels would silently misalign. MIT-safe (class names are facts, not code).
"""
...
IMAGENET_CLASS_NAMES: List[str] = [
    ...
    "toyshop", "tractor", "trailer", "tray", "trench coat",
    # 900-999
