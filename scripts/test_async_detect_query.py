...
Usage:
    ...
    python3 scripts/test_async_detect_query.py --image assets/bus.jpg --save result.jpg
    python3 scripts/test_async_detect_query.py --url https://ultralytics.com/images/bus.jpg \
