...
Usage:
    python3 scripts/test_async_vlm_query.py --image assets/bus.jpg
    python3 scripts/test_async_vlm_query.py --image assets/bus.jpg --save answer.txt
    python3 scripts/test_async_vlm_query.py --url https://ultralytics.com/images/bus.jpg \
