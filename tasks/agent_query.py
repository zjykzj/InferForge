...
9 agent run failure / 3 internal), but delivery is a Redis write instead of
a callback POST — no retry logic.
"""
import logging
...
def agent_query_task(self, image_b64=None, image_url=None, request_id="-", submitted_at=None):
    ...
    """
    logger.info("agent query task started: has_image=%s has_url=%s",
